                  ...
                  <div className="border border-gray-300 rounded-lg overflow-hidden bg-gray-50 relative no-screenshot select-none">
                    ...
                    >
                      ...
                      {fileData.file.content_type.startsWith('image/') ? (
                        ...
                        fileData.file.disable_download ? (
                          <div className="flex items-center justify-center h-full">
                            <div className="text-center max-w-md p-6">
                              ...
                              <p className="text-sm text-gray-600 mb-4">
                                This PDF has download protection enabled. Browser PDF viewers have built-in download controls that cannot be disabled, which would bypass the protection.
                              </p>
                              <p className="text-xs text-gray-500">
                                The file owner has prioritized security over preview functionality.
                              </p>
                            </div>
                          </div>
                        ) : (
                          <div className="w-full h-full relative">
                            <div className="absolute top-2 left-2 right-2 bg-yellow-100 border border-yellow-400 rounded px-3 py-2 text-xs text-yellow-800 z-50">
                              ⚠️ PDF viewers may have built-in download controls. For maximum protection, the uploader should enable "Disable Download".
                            </div>
                            <embed
                            ...
                            />
                            {/* Overlay to block right-click on PDF */}
                            <div 
